...
func SerializeStage(stage *StageStruct, filename string) {
	...
	{
		// insertion point
		SerializeExcelize[DisplaySelection](stage, f)
		SerializeExcelize[XLCell](stage, f)
		SerializeExcelize[XLFile](stage, f)
		SerializeExcelize[XLRow](stage, f)
		SerializeExcelize[XLSheet](stage, f)
	}
