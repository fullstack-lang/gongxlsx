...
func fillUpTree(
	...
	for _, gongStruct := range sliceOfGongStructsSorted {
		...
		case "DisplaySelection":
			...
			for displayselection := range set {
				nodeInstance := (&gongtree_models.Node{Name: displayselection.GetName()}).Stage(playground.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(displayselection, "DisplaySelection", playground)
		...
		case "XLCell":
			...
			for xlcell := range set {
				nodeInstance := (&gongtree_models.Node{Name: xlcell.GetName()}).Stage(playground.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(xlcell, "XLCell", playground)
		...
		case "XLFile":
			...
			for xlfile := range set {
				nodeInstance := (&gongtree_models.Node{Name: xlfile.GetName()}).Stage(playground.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(xlfile, "XLFile", playground)
		...
		case "XLRow":
			...
			for xlrow := range set {
				nodeInstance := (&gongtree_models.Node{Name: xlrow.GetName()}).Stage(playground.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(xlrow, "XLRow", playground)
		...
		case "XLSheet":
			...
			for xlsheet := range set {
				nodeInstance := (&gongtree_models.Node{Name: xlsheet.GetName()}).Stage(playground.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(xlsheet, "XLSheet", playground)
