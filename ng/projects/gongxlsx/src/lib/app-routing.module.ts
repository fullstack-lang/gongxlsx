...
const routes: Routes = [ // insertion point for routes declarations
	...
	{ path: 'github_com_fullstack_lang_gongxlsx_go-xlcell-adder/:id/:association', component: XLCellDetailComponent, outlet: 'github_com_fullstack_lang_gongxlsx_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongxlsx_go-xlfile-adder/:id/:association', component: XLFileDetailComponent, outlet: 'github_com_fullstack_lang_gongxlsx_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongxlsx_go-xlrow-adder/:id/:association', component: XLRowDetailComponent, outlet: 'github_com_fullstack_lang_gongxlsx_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongxlsx_go-xlsheet-adder/:id/:association', component: XLSheetDetailComponent, outlet: 'github_com_fullstack_lang_gongxlsx_go_editor' },
