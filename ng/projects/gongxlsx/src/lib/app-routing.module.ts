...
const routes: Routes = [ // insertion point for routes declarations
	{ path: 'xlcells', component: XLCellsTableComponent, outlet: 'table' },
	{ path: 'xlcell-adder', component: XLCellDetailComponent, outlet: 'editor' },
	{ path: 'xlcell-adder/:id/:association', component: XLCellDetailComponent, outlet: 'editor' },
	{ path: 'xlcell-detail/:id', component: XLCellDetailComponent, outlet: 'editor' },
	{ path: 'xlcell-presentation/:id', component: XLCellPresentationComponent, outlet: 'presentation' },
	{ path: 'xlcell-presentation-special/:id', component: XLCellPresentationComponent, outlet: 'xlcellpres' },
